  ...
  return (
    <div className="bg-yt-dark text-yt-text min-h-screen">
      <div className="flex pt-14">
        <div
          className={`flex-1 transition-all duration-300 ${sidebarOpen ? "ml-64" : "ml-0"} p-6`}
        >
          {/* Search Header */}
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-2">
              <SearchIcon className="text-yt-secondary" />
              <h2 className="text-2xl font-semibold text-yt-text">
                Search results for: "
                <span className="text-yt-red">{query}</span>"
              </h2>
            </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-96">
              <SearchIcon className="text-6xl text-yt-hover mb-4" />
              <p className="text-yt-secondary text-lg">
                No results found for "{query}"
              </p>
              <p className="text-yt-secondary text-sm mt-2">
